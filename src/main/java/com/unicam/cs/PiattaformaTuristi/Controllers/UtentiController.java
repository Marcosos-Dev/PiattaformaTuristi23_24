...
public class UtentiController {
    ...
    public void registraUtente(String username, String password){ this.gestoreUtenti.aggiungiUtente(new UtenteAutenticato(username,password)); }

    public boolean autenticaUtente(String username, String password){ return this.gestoreUtenti.autenticaUtente(username,password); }

    public List<RuoloUtente> getPossibiliRuoli(RuoloUtente ruolo){ return RuoloUtente.getPossibiliRuoliDefault().stream().filter(x -> !x.equals(ruolo)).toList(); }
    ...
    public void gestisciRuolo(int idUtente, RuoloUtente nuovoRuolo){ this.gestoreUtenti.modificaRuolo(idUtente, nuovoRuolo); }

    public void aggiungiRichiestaRuolo(Richiesta richiesta){ this.gestoreUtenti.aggiungiRichiestaRuolo(richiesta); }

    public UtenteAutenticato getUtenteDaUsername(String username){ return this.gestoreUtenti.getUtenteTramiteUsername(username); }
