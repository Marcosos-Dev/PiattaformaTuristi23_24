...
public class TestingContest {
    ...
    public void creaContest(String tipo){
        ...
        InterfacciaAnimatore i = new InterfacciaAnimatore(c,animatore);
    ...
    public void partecipaContestSenzaInvito(){
        InterfacciaContributore i = new InterfacciaContributore(c,contributor1);
    ...
    public void partecipaContestPubblico() throws URISyntaxException {
        InterfacciaContributore i1 = new InterfacciaContributore(c,contributor1);
        InterfacciaContributore i2 = new InterfacciaContributore(c,contributor2);
